        ...
        <DialogContent>
          <PapperBlock whiteBg title="General Information">
            <Grid container spacing={4}>
              ...
              <Grid item xs={2}>
                <Typography variant="subtitle1" color="primary">Landlord Name</Typography>
                <Typography variant="body1">{data.lanlord_account_name}</Typography>
              </Grid>
              <Grid item xs={2}>
                <Typography variant="subtitle1" color="primary">Cancellation Reason</Typography>
                <Typography variant="body1">{data.cancellation_reason}</Typography>
              </Grid>
              <Grid item xs={2}>
                <Typography variant="subtitle1" color="primary">Decline Reason</Typography>
                <Typography variant="body1">{data.decline_reason_1}</Typography>
              </Grid>
              <Grid item xs={2}>
                <Typography variant="subtitle1" color="primary">Estimated Decline Rate</Typography>
          ...
          <PapperBlock whiteBg title="Rider Details">
            <Grid container spacing={4}>
              ...
              <Grid item xs={2}>
                <Typography variant="subtitle1" color="primary">Gross Monthly Rent</Typography>
                <Typography variant="body1">{data.gross_monthly_rent}</Typography>
              </Grid>
              <Grid item xs={2}>
                <Typography variant="subtitle1" color="primary">Gross Annual Rent</Typography>
                <Typography variant="body1">{data.gross_annual_rent}</Typography>
              </Grid>
              <Grid item xs={2}>
