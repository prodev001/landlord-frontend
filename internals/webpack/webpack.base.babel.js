...
module.exports = options => ({
  ...
  resolve: {
    ...
    alias: {
      'leap-components': path.resolve(__dirname, '../../app/components/'),
      'leap-actions': path.resolve(__dirname, '../../app/actions/'),
      'leap-redux': path.resolve(__dirname, '../../app/redux/'),
      'leap-styles': path.resolve(__dirname, '../../app/styles/components/'),
      'leap-api': path.resolve(__dirname, '../../app/api/'),
      'leap-images': path.resolve(__dirname, '../../public/images/'),
      'leap-vendor': path.resolve(__dirname, '../../node_modules/'),
    }
  },
